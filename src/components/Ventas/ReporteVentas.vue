  ...
  <section>
    ...
    <div class="box" v-if="filtrar">
      <b-field grouped group-multiline>
        ...
        <b-field label="Maletas/Cajas por usuario" expanded>
          <b-select
    ...
    >
      ...
      <b-table-column field="insumos" label="Insumos" v-slot="props">
        <b-table :data="props.row.insumos" :narrowed="true" class="is-size-8">
          ...
          <b-table-column field="descripcion" label="Declaración" v-slot="props">
