<template>
  <section>
    <p class="title is-1 has-text-weight-bold">
      ...
      Armar Equipaje/Caja #{{ idMesa }}
      <b-field
        label="Nombre de Maleta/Caja (Opcional)"
        class="is-pulled-right"
        expanded
      >
        <b-input required placeholder="Ej. Maleta 1" v-model="cliente"></b-input>
      </b-field>
    </p>
              ...
              <header class="card-header">
                <div class="card-header-title is-size-7">
                  <b-icon
                    ...
                    icon="noodles"
                    class="has-text-info"
                    v-if="insumo.tipo === 'Encomienda'"
                  ></b-icon>
                  <b-icon
                    icon="cup"
                    size="is-small"
                    class="has-text-success"
                    v-if="insumo.tipo === 'Correo/En Linea'"
                  ></b-icon>
                  {{ insumo.nombre }}
                </div>
                <b-button
